...
constexpr int kBeansIndex = 0;
constexpr int kCandyIndex = 1;
constexpr int kFishIndex = 2;
constexpr int kPastaIndex = 3;
constexpr int kRiceIndex = 4;
constexpr int kSpicesIndex = 5;
constexpr int kTeaIndex = 6;
constexpr int kTomatosauceIndex = 7;
constexpr int kVinegarIndex = 8;
constexpr int kWaterIndex = 9;
